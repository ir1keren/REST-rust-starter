...
# Rust MVC API - Podman Helper Script
# Usage: ./podman-helper.sh [build|run|stop|logs|test|clean]
...
case "$1" in
    ...
    test)
        ...
        curl -f -s http://localhost:$PORT/api/projects && echo " ✅ Projects endpoint working"
    ...
    *)
        echo "Rust MVC API - Podman Helper"
        echo ""
